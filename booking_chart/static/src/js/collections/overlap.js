openerp.unleashed.module('booking_chart', function(booking, _, Backbone, base){
    ...
    var Overlap = Group.extend({
	    ...
	    // TODO: period model to be used inside the overlap
	    period_model: Period,
         ...
         * it's being overlapped with a group or not. Using 'Twix' to compare the time
         * range for overlaps
         *
        ...
        addToGroup: function(model, index){
            ...
            var start = model.get(this.options.attr_date_start),
                ...
                model_period = new this.period_model({start: moment(start), end: moment(end)}, this.options),
